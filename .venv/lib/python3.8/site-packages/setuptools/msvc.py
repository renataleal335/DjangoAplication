...
def msvc9_find_vcvarsall(version):
    ...
    try:
        ...
        produtodir = Reg.get_value(key, "installdir")
    except KeyError:
        try:
    ...
    if produtodir:
        vcvarsall = join(produtodir, "vcvarsall.bat")
        if isfile(vcvarsall):
            return vcvarsall
...
class SystemInfo:
    ...
    def FSharpInstallDir(self):
        ...
        return self.ri.lookup(path, 'produtodir') or ''
...
class EnvironmentInfo:
    ...
    def VCRuntimeRedist(self):
        ...
        # vcruntime path
        for prefix, crt_dir in itertools.produto(prefixes, crt_dirs):
